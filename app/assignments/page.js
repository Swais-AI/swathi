          ...
          <div className="assignment-layout">
            <article className="module-card assignment-list-card">
              ...
              <nav className="assignment-view-nav assignment-list-subnav" aria-label="Assignment list views">
                <button
                  className={assignmentListTab === "assignments" ? "active" : ""}
                  type="button"
                  onClick={() => setAssignmentListTab("assignments")}
                >
                  All Assignments <span>{assignments.length}</span>
                </button>
                <button
                  className={assignmentListTab === "materials" ? "active" : ""}
                  type="button"
                  onClick={() => setAssignmentListTab("materials")}
                >
              ...
              {assignmentListTab === "materials" && <table className="data-table">
                ...
                <tbody>
                  {assignmentsWithMaterials.flatMap((assignment) => (
                  ...
                  {!loading && assignmentsWithMaterials.length === 0 && (
                    <tr><td colSpan="3">No assignment materials available.</td></tr>
                  )}
                </tbody>
              </table>}
